...
QGC_LOGGING_CATEGORY(GranelComplexItemLog, "GranelComplexItemLog")

const QString GranelComplexItem::name(GranelComplexItem::tr("Granel"));

GranelComplexItem::GranelComplexItem(PlanMasterController* masterController, bool flyView, const QString& kmlOrShpFile)
      ...
      , _entryPoint               (EntryLocationTopLeft)
{
    ...
    connect(&_gridAngleFact,            &Fact::valueChanged,                        this, &GranelComplexItem::_setDirty);
    connect(&_flyAlternateTransectsFact,&Fact::valueChanged,                        this, &GranelComplexItem::_setDirty);
    connect(&_splitConcavePolygonsFact, &Fact::valueChanged,                        this, &GranelComplexItem::_setDirty);
    connect(this,                       &GranelComplexItem::refly90DegreesChanged,  this, &GranelComplexItem::_setDirty);

    connect(&_gridAngleFact,            &Fact::valueChanged,                        this, &GranelComplexItem::_rebuildTransects);
    connect(&_flyAlternateTransectsFact,&Fact::valueChanged,                        this, &GranelComplexItem::_rebuildTransects);
    connect(&_splitConcavePolygonsFact, &Fact::valueChanged,                        this, &GranelComplexItem::_rebuildTransects);
    connect(this,                       &GranelComplexItem::refly90DegreesChanged,  this, &GranelComplexItem::_rebuildTransects);

    connect(&_surveyAreaPolygon,        &QGCMapPolygon::isValidChanged,             this, &GranelComplexItem::_updateWizardMode);
    connect(&_surveyAreaPolygon,        &QGCMapPolygon::traceModeChanged,           this, &GranelComplexItem::_updateWizardMode);
...
void GranelComplexItem::save(QJsonArray&  planItems)
{
...
void GranelComplexItem::savePreset(const QString& name)
{
    QJsonObject saveObject;
...
void GranelComplexItem::_saveCommon(QJsonObject& saveObject)
{
...
void GranelComplexItem::loadPreset(const QString& name)
{
    QString errorString;
...
bool GranelComplexItem::load(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
{
...
bool GranelComplexItem::_loadV4V5(const QJsonObject& complexObject, int sequenceNumber, QString& errorString, int version, bool forPresets)
{
...
bool GranelComplexItem::_loadV3(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
{
...
void GranelComplexItem::_reverseTransectOrder(QList<QList<QGeoCoordinate>>& transects)
{
...
void GranelComplexItem::_reverseInternalTransectPoints(QList<QList<QGeoCoordinate>>& transects)
{
...
void GranelComplexItem::_optimizeTransectsForShortestDistance(const QGeoCoordinate& distanceCoord, QList<QList<QGeoCoordinate>>& transects)
{
...
qreal GranelComplexItem::_ccw(QPointF pt1, QPointF pt2, QPointF pt3)
{
    return (pt2.x()-pt1.x())*(pt3.y()-pt1.y()) - (pt2.y()-pt1.y())*(pt3.x()-pt1.x());
}

qreal GranelComplexItem::_dp(QPointF pt1, QPointF pt2)
{
    return (pt2.x()-pt1.x())/qSqrt((pt2.x()-pt1.x())*(pt2.x()-pt1.x()) + (pt2.y()-pt1.y())*(pt2.y()-pt1.y()));
}

void GranelComplexItem::_swapPoints(QList<QPointF>& points, int index1, int index2)
{
...
bool GranelComplexItem::_gridAngleIsNorthSouthTransects()
{
...
void GranelComplexItem::_adjustTransectsToEntryPointLocation(QList<QList<QGeoCoordinate>>& transects)
{
    ...
    if (reversePoints) {
        qCDebug(GranelComplexItemLog) << "_adjustTransectsToEntryPointLocation Reverse Points";
        _reverseInternalTransectPoints(transects);
    }
    if (reverseTransects) {
        qCDebug(GranelComplexItemLog) << "_adjustTransectsToEntryPointLocation Reverse Transects";
        _reverseTransectOrder(transects);
    }

    qCDebug(GranelComplexItemLog) << "_adjustTransectsToEntryPointLocation Modified entry point:entryLocation" << transects.first().first() << _entryPoint;
}

QPointF GranelComplexItem::_rotatePoint(const QPointF& point, const QPointF& origin, double angle)
{
    QPointF rotated;
...
void GranelComplexItem::_intersectLinesWithRect(const QList<QLineF>& lineList, const QRectF& boundRect, QList<QLineF>& resultLines)
{
...
void GranelComplexItem::_intersectLinesWithPolygon(const QList<QLineF>& lineList, const QPolygonF& polygon, QList<QLineF>& resultLines)
{
    resultLines.clear();
...
void GranelComplexItem::_adjustLineDirection(const QList<QLineF>& lineList, QList<QLineF>& resultLines)
{
    qreal firstAngle = 0;
    for (int i=0; i<lineList.count(); i++) {
        const QLineF& line = lineList[i];
...
double GranelComplexItem::_clampGridAngle90(double gridAngle)
{
...
bool GranelComplexItem::_nextTransectCoord(const QList<QGeoCoordinate>& transectPoints, int pointIndex, QGeoCoordinate& coord)
{
...
bool GranelComplexItem::_hasTurnaround(void) const
{
    return _turnAroundDistance() > 0;
}

double GranelComplexItem::_turnaroundDistance(void) const
{
    return _turnAroundDistanceFact.rawValue().toDouble();
}

void GranelComplexItem::_rebuildTransectsPhase1(void)
{
...
void GranelComplexItem::_rebuildTransectsPhase1WorkerSinglePolygon(bool refly)
{
    if (_ignoreRecalc) {
        return;
    }
    ...
    qCDebug(GranelComplexItemLog) << "_rebuildTransectsPhase1 Convert polygon to NED - _surveyAreaPolygon.count():tangentOrigin" << _surveyAreaPolygon.count() << tangentOrigin;
    for (int i=0; i<_surveyAreaPolygon.count(); i++) {
        ...
        qCDebug(GranelComplexItemLog) << "_rebuildTransectsPhase1 vertex:x:y" << vertex << polygonPoints.last().x() << polygonPoints.last().y();
    }
    ...
    qCDebug(GranelComplexItemLog) << "_rebuildTransectsPhase1 Clamped grid angle" << gridAngle;

    qCDebug(GranelComplexItemLog) << "_rebuildTransectsPhase1 gridSpacing:gridAngle:refly" << gridSpacing << gridAngle << refly;

            // Convert polygon to bounding rect

    qCDebug(GranelComplexItemLog) << "_rebuildTransectsPhase1 Polygon";
    QPolygonF polygon;
    for (int i=0; i<polygonPoints.count(); i++) {
        qCDebug(GranelComplexItemLog) << "Vertex" << polygonPoints[i];
        polygon << polygonPoints[i];
    }
    polygon << polygonPoints[0];
    QRectF boundingRect = polygon.boundingRect();
    QPointF boundingCenter = boundingRect.center();
    qCDebug(GranelComplexItemLog) << "Bounding rect" << boundingRect.topLeft().x() << boundingRect.topLeft().y() << boundingRect.bottomRight().x() << boundingRect.bottomRight().y();
    ...
    for (const QList<QGeoCoordinate>& transect : transects) {
        ...
        if (triggerCamera() && hoverAndCaptureEnabled()) {
            ...
            if (triggerDistance() < transectLength) {
                ...
                qCDebug(GranelComplexItemLog) << "cInnerHoverPoints" << cInnerHoverPoints;
...
void GranelComplexItem::_rebuildTransectsPhase1WorkerSplitPolygons(bool refly)
{
    if (_ignoreRecalc) {
        return;
    }
...
//        qCDebug(GranelComplexItemLog) << "Transects from polynom p " << p;
        _rebuildTransectsFromPolygon(refly, *p, tangentOrigin, vMatch);
    }
}

void GranelComplexItem::_PolygonDecomposeConvex(const QPolygonF& polygon, QList<QPolygonF>& decomposedPolygons)
{
...
bool GranelComplexItem::_VertexCanSeeOther(const QPolygonF& polygon, const QPointF* vertexA, const QPointF* vertexB) {
...
//    qCDebug(GranelComplexItemLog) << "_VertexCanSeeOther false after first checks ";
...
//    qCDebug(GranelComplexItemLog) << "_VertexCanSeeOther distanceAB " << distanceAB;
...
//            qCDebug(GranelComplexItemLog) << "*vertexA " << *vertexA << "*vertexB " << *vertexB  << " intersection " << intersection;
            ...
            qCDebug(GranelComplexItemLog) << "_VertexCanSeeOther distanceIntersection " << distanceIntersection;
...
bool GranelComplexItem::_VertexIsReflex(const QPolygonF& polygon, QList<QPointF>::const_iterator& vertexIter) {
...
void GranelComplexItem::_rebuildTransectsFromPolygon(bool refly, const QPolygonF& polygon, const QGeoCoordinate& tangentOrigin, const QPointF* const transitionPoint)
{
    // Generate transects
    ...
    qCDebug(GranelComplexItemLog) << "_transects.size() " << _transects.size();
}

void GranelComplexItem::_recalcCameraShots(void)
{
...
GranelComplexItem::ReadyForSaveState GranelComplexItem::readyForSaveState(void) const
{
    return TransectStyleComplexItem::readyForSaveState();
}

void GranelComplexItem::rotateEntryPoint(void)
{
...
double GranelComplexItem::timeBetweenShots(void)
{
    return _vehicleSpeed == 0 ? 0 : triggerDistance() / _vehicleSpeed;
}

double GranelComplexItem::additionalTimeDelay (void) const
{
    double hoverTime = 0;
...
void GranelComplexItem::_updateWizardMode(void)
{
