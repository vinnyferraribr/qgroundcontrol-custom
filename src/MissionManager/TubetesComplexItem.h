...
Q_DECLARE_LOGGING_CATEGORY(TubetesComplexItemLog)

class PlanMasterController;
class MissionItem;

class TubetesComplexItem : public TransectStyleComplexItem
{
    Q_OBJECT
   ...
   public:
    ...
    TubetesComplexItem(PlanMasterController* masterController, bool flyView, const QString& kmlOrShpFile);
    ...
    QString             commandDescription  (void) const final { return tr("Tubetes"); }
    QString             commandName         (void) const final { return tr("Tubetes"); }
    ...
    static const QString name;
            ...
            // Keep json type strings for compatibility with existing plans
    static constexpr const char* jsonComplexItemTypeValue =   "survey";
    static constexpr const char* jsonV3ComplexItemTypeValue = "survey";

            // Settings keys (left as Survey for compatibility with existing settings JSON)
