...
Q_DECLARE_LOGGING_CATEGORY(GranelComplexItemLog)

class PlanMasterController;
class MissionItem;

class GranelComplexItem : public TransectStyleComplexItem
{
    Q_OBJECT
   ...
   public:
    ...
    GranelComplexItem(PlanMasterController* masterController, bool flyView, const QString& kmlOrShpFile);
    ...
    QString             commandDescription  (void) const final { return tr("Granel"); }
    QString             commandName         (void) const final { return tr("Granel"); }
